...
public class Labyrinthe {
    ...
    static boolean deplace(char direction) {
        ...
        if (player.getY() == Labyrinthe.exitPos + 0.5 && player.getX() == Labyrinthe.width - 0.5) {
        	JOptionPane.showMessageDialog(Laby.frame, "Bravo, vous Ítes parvenu jusqu'‡ la sortie en commettant seulement "+(Labyrinthe.healthPoints - Labyrinthe.player.getHP())+"erreurs.");
            Laby.endGame();
        }
